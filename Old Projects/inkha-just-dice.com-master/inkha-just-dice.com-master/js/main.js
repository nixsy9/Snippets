...
function update_graphs() {
    ...
    var plotc = $.plot("#g_placeholder3", [generate_ev_graph()], {
        series: {
            color: '#cdffcc'
        },
        threshold: 0,
    ...
    plotc.setData([generate_ev_graph()]);
...
function gui() { //
    ...
    $showhidetrigger3 = $('<button title="Toggles bot graph" style="margin-right:10px;border:1px solid" id="showhidetrigger3" href="#">profit</button>'); //toggle hide for graph
      
