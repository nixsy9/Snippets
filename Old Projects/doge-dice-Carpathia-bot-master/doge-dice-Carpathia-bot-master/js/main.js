...
function gui() { //
	...
	$button_group.append("<div align='center' style='color:white;font-size:10pt;'>Carpathia Bot</div>");
...
$(document).ready(function () {
	...
	console.log('Welcome to the Carpathia Suite V1');
	log_message('Welcome to the Carpathia Suite V1');
	console.log('\n');
	heart_beat();
