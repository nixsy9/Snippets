...
function value_grip() {
	if (start_values_check == 0) { // Grab start values here
...
function bet_click(bet_value) {
	...
	if (lose1 < marti_limit && betting == 0 && running == 1) {
...
function gui() { //style="background-image: url(' + background_imgage +')"
	...
	var $row2c = $('<div class="row"/>'); ////////////////////////////////////// row 1c
	...
	var $row3c = $('<div class="row"/>'); ////////////////////////////////////////////// row 2c
...
$(document).ready(function () {
	...
	console.log('Welcome to the Nix Enhancement Suite V3');
	log_message('Welcome to the Nix Enhancement Suite V3');
	console.log('\n');
	heart_beat();
